...
mamethali = [
	...
	["Afadhali achimbaye jiwe kuliko azuruaye (afadhali anayefanya kazi yo yote kuliko mvivu).", "Better the one who digs a stone than the one who Loaves.(i.e. a worker is better than a lazy person)."],
	...
	["Afadhali kuchukiwa na kiongozi kuliko kuchukiwa na watu.", "It is better to be hated by the leader/ruler than by the orowd (or neighbours),"],
	...
	["Akataaye kitu ati wamempa kidogo huvimba kichwa (hukaa na hasira).", "The one who refuses something because he thinks Lhal he has been given littie, ( big head (i.e. remains wi anger).", "ch"],
	["Akohoaye akitema huwa anajipisha (mtu akikohoa huku akitema kikohozi huwa anapunguza usumbufu kohoni ~ ajaribuye kitu baadaye hufaulu).", "The one who coughs and spits relives himself (the one who Lples afler sometime succeeds)."],
	["Akuchukiaye hakutoi mahali ulipo, ila naogopa mauti (Kihaya: katamuzi).", "The one who hat peoperty in Haya: you never removes you death is what J am afr from your own of Chere death"],
	...
	["Aliyeandaa pombe hachekei pombe iliyotengenezwa vibaya (Kihaya: kenku).", "One who has prepared beer does not laugh at the beer which tastes bad (Haya: kenku)."],
	["Aliyepoteza hatafuti mahali pamoja.", "One whe has lost something never searches only one place."],
	...
	["Ameanguka (mnyama k.m.", "ng'ombe) wakachinja (hawachinji isipoanguka au kabla ya kuanguka).", "It (i.e. an animal e.g.", "a cow) has Fallen so they have slaughtered it (i.e. they never slaughter if it has not fallen or before it falls)."],
	...
	["Anajikaza kisabuni (anajikaza awezavyo ingawa ana shida au ni mgonjwa).", "Someone has courage as scap (i.e. someone is trying his best.although he has problems)."],
	...
	["Anasema ya kuni na maji (anasema maneno mengi au analalamika kwa aguvu zote juu ya kitu fulani).", "Someone speaks of firswood anc water (i.e. someone is shouting or he is complaining about scmething with all his strength)."],
	...
	["Apendaye urembo (hasa kusukwa nywele) hapigi kelele.", "One who likes ornamentation (e.g.", "to be plaited etc.) does not ory."],
	...
	["Asiyeziingiza (mbuzi au kuku n.k.) mapema hulia kama zenyewe.", "One whe has not pursued them (e.g.", "goats, sheep, chicken etc) early he ories as they do before sunset."],
	...
	["Bugubugu' si moto (kitoacho ulimi wa moto si lazima kuwa ni moto uchomao) ey"],
	...
	["Cha mbaya wako hulishwa na mwema wako.", "What is of your bad relative or friend is fed by your beloved,"],
	...
	["Damu hutoa harufu (watu wa ukoo mmoja hawakosi kutambuana).", "Blood smelis (i.e. people of the sume clan never Fail to know one another)."],
	...
	["Domo kaya samli kwa mwenye ng'ombe.", "‘The miser eats ghee at the cattle-owner."],
 	...
 	["Elimu haina mwisho (hakuna aliye mzee mno asijifunze).", "Education has no end (i.e. there is no one too old to learn)."],
	...
	["Hakuna hebu nikuulize (katika maandalio ya sherehe kila kitu kimepangwa vizguri).", "There is no 'let us go out so that may ask you' (i.e. everything at the feast is well arranged)."],
	...
	["Hata alimaye pazuri hupumzika na kurudi nywmbani.", "Even one who farms good soil rests and gces home."],
	["hata mtoto waka aweza kukupa mashauri au kukufanyia kitu ukapendezwa).", "Even your child can pl your child ean give yo pleases you).", "y a drum and you dance (i.e. even advice or can do something that"],
	["Hautapambazuka' aliua mkewe.", "‘Tt will not dawn', killed his wife."],
  	["Hawapendeani vicheko (baadhi ya watu hawapendi wengine wawe na furaha).", "Th do not wish one another laughter (i.e. some peaple do not like others to have happiness)."],
	["Hazikosi kusimuliwa (habari huenea upesi).", "Words never fail to spread (i.", "words s quickly).", "ogken gpread"],
	...
	["Heshima humfanya mtu apate.", "(aheshimuye wengine hupendwa na watu).", "Respect provides (i.e. the one who respects others is toved by ople)."],
	["Hiari ya moyo dawa,.", "The willingness of the heart is medicine."],
	["Huanguka na kuinuka (maisha ya mw leo ana furaha kesho ana shida).", "adamu hayanyoki They fall and rise (i.e. man's life is not stable; tcday he apiness tomorrow he has difficulties."],
	["Huendapo waishipo vyura (Kihaya: Bunyira), huishi kama vyura waishivyo (uendapo mahali fulani nawe kwa namna fulani huishi kama wao waishivyo).", "When you go to where Frogs stay you live as frogs do (i.e. when you go somewhere you also to some extent live as"],
	["(Meno) hujitokeza (pakiwepo kitu cha kumfanya mtu acheke, hakuna sababu ya kumwambia mtu 'cheka').", "(Teeth) appear themselves (i.e. when there is something to laugh at, there is no reason to tell someone 'laugh')."],
  	["Hukumu haijui nyumba maskini (mtu ye yote aweza kuhukumiwa hata maskini) .", "Justice does not know a poor house (i.e. anyone can be judged, even the pcor)."],
	["Hukutuma umefika mwenyewe (umenituma nami nitafikisha habari kana kwamba ni wewe mwenyewe umefika).", "You have not sent the message you have reached yourself (i.e. you have sent me the message,I shall deliver them as though you have gone yourself)"],
	["(Makubwa) humpata aliyeoa au olewa (maisha ya huzuni au ya furaha huyajua hasa aliyeishaoa au aliyeishaolewa).", "A married man or woman has much to face."],
	["Hupenda roho (watu huvutwa na roho ya mtu).", "They like the spirit of a person (i.e. people are attracted by the spirit of a person)."],
	...
	["{Ugonjwa) hupika chake (mgonjwa ambaye hapendi kula watu husema ‘ugonjwa wake utaelekeza chakula atakachopikiwa').", "(Illness) will cook its own food (i.e. of a palient who has problems with food people say, his illness will direct which kind of food will be cooked for him)."],
	...
	["Je, jua umelifunga na kamba? (huharakishi uki jua limesimama likikungoja).", "Do you think that you have tied the sun with a repe? (i.e. you do not hurry up thinking thet the sun is standing still waiting for you)."],
	["Jikaze kiume (uwe na ujasiri kama wanaune wafanikiwao wafanyavyo).", "Have courage as a man (i.e. be courageous as other successful men do)."],
	...
	["Jitazame (angalia mwenendo wako, au jirudi).", "Check yourself (i.e. discipline yourself or consider the past and see where you stand)."],
	["Jivuli la mvumo humfunika aliye mbali.", "The long shadow of the borassus palm shelters him thut is far off."],
	["Jogoo aliveshiba ndiye huwika.", "A cock that is satisfied with food is the one which orows."],
	["Kakimbia mkuki kaangukia mshale (amezingiriwa na taabu pande zote).", "‘ Someone escaped being shot by the spear but has fallen by the arrow (i.e. someone is surrounded by difficulties on every side)."],
	["Kama mwanamke hakutulia ni huzuni kubwa nyumbani.", "If the wife is worried the house is melancholic."],
	["Karamu mbili zilimfanya kunguru kuwa na migquu inayokwenda ikigaagaa.", "Two feasts made a orow to have legs that roam about."],
	["Karanga huchemka halafu hupoa (mwenye hasira baadaye hutulia).", "Groundnuts pop up when they are being cooked but later cool dewn (i.e. an angry person later cools down)."],
	...
	["Kibaya hukiona mara moja (mtu hapendi kuona kibaya mara ya pili au mara nyingi).", "A misfortune you see once (i.e. a person does not like to see misfortune more than once)."],
	["Kibaya hukizaa hukinunui.", "You bear a bad thing, you never buy it."],
	["kuliko kumnyima mtu).", "A Little is better than nothing (i.e. it is better that = give someone something little than refuse him)."],
	...
	["Kila mnoja ana shimo lake (kila mmoja atazikwa katika kaburi lake}.", "Everyone will have his own hole (i.e. everyone will be buried in his own grave)."],
	["Kila mmoja nyumba yake (kila mmoja ana siri zake au kila mtu hutoshelezwa na nyumba yake au chumba chake).", "Everyone has his cwn house oz home (i.e. everyone hus his seorets or a porsen is satisfied with one's own house or room)."],
	...
	["Kilio kinatoka kifuani (anatenda hivyo kwa kuwa ana nguvu au ameshiba).", "The ory is from the chest (i.e. he is doing so because he is strong or he is not hungry)."],
	...
	["Kisichokwewa ni mti wa miiba (Kihaya: omutangalala}) (mtu jangiri ni shida kupatana au kushirikiana naye).", "What one cannot climb is a thorny tree.(i.e. a bad person is difficult to associate with)."],
	...
	["Kiumbe hakamiliki kuumbwa mpaka kufa.", "A oreature is not completely oreated until death."],
	["Kizaacho hufa.", "That which produces or bears, also dies."],
	["Kofi la mahaba hhaliumizi.", "A slap cf love does not hurt."],
	["Kovu halikwanguliwi.", "A sear is never soraped,"],
	["Kuacha mbacha kwa msala upitao.", "To leave an old mat for a mat that is passing."],
	["Kuaguka 'kibandagala' (kufika kwa mtu bila taarifa).", "To fall 'kibandapalat (i.e. to visit someone without giving notice)."],
	...
	["Kufa maradufu kama makaa (kupambana na shida mara mbili au hata zaidi).", "To die twice as chareoal (i.e. to face problems lLwice or regularly)."],
	...
	["Kuku wa mwingine humtupii jiwe.", "You never throw a stone at your neighbour's hen."],
  	["Kula na kilio (mwenye choye hula huku akilia kuwa ana vichache) .", "To eat orying (i.e. a gready person is never satisfied)."],
	...
	["Kurudi mara ya pili kulimfanya mwizi ashikwe (kurudia kufanya kosa mara nyingi kwaweza kumhatarisha mtu).", "Returning a second time led a thief to capture (i.e. to repeat a fault can endanger a person)."],
	["Kusema, 'kama ningelifahamu' huja baadaye.", "To say “had I known' comes later."],
	["Kusema 'kuja mwangalie’ hakuchelewi (hatari huja upesi).", "To say 'Oh come and see' does not delay (i.e. misfortune comes suddenly)."],
	...
	["Kutupa jiwe majini (kusahau mtu kabisa.", "Mithali hii hutumiwa na mtu akimwambia mwingine kuwa hamkumbuki tena) To threw a stone in the lake or sea (i.e. to forget some- one completely.", "This proverb is used by a person telling someone that he has no remembrance of him)."],
	...
	["Kwenda mkumboni (kufuata wengine bila sababu).", "To follow the orowd (i.e. to follow the majority without having any reason to do so),"],
	...
	["Majani ya mgomba hukatwa (urithi hugawanywa kufuata watoto walivyo).", "Dry banana leaves are cut (ile..inheritance is divided to children according to how children are)."],
	...
	["Maji ya mbali hutumia kidego upikapo (kitu ambacho ni shida kukipata hutumia kwa uangalifu) .", "The water which you fetch from far, you use little when cooking (i.e. something that is difficult to get you use it carefully)."],
	...
	["Mama-mkwe hafungui mdomo (mama-mkwe hasemi ovyoovyo mbele ya mkwe wake au hamtukani).", "Mother-in-law never opens her mouth (i.e. the mother-in-law takes care when speaking to her son-in-law opr does not abuse her son-in-law)."],
	...
	["Mauti hajali (mauti huua mimba, mtoto mchanga, kijana au mtu mzima).", "Death never cares (i.e. death kills people of different ages)."],
	...
	["Meno ni undugu (mwenye kucheka au kushirikiana na wengine huwa na uhusiano mwema na watu).", "Teeth are brotherhood (i.e. the one who laughs opr communicates with others continues having good relation- ship with people)."],
	["Mfalme au mtawala afapo ndipo siri hutobolewa.", "When the king or the leader dies, the seoret is revealed."],
	...
	["Mfu ni mtamu (mtu akifa watu wengi hukusanyika hata wale ambao hawakujali kumtazama kabla hajafa).", "A dead person is loved (i.e. when a person dies many people come to lament for him, even those who did not bother to visit him when he was still alive)."],
	["Mgeni hufungua macho (mgeni ni mdadisi).", "A visitor watches attentively (i.e. a visitor is too inquisitive)."],
	["Mguu ni ujamaa (kutembeleana hudumisha ujamaa au urafiki).", "A leg is brotherhood (i.e. to visit one another strengthens friendship or brotherhood)."],
	...
	["Mhunzi alijenga karibu na barabara ili apate mashauri (mtaka mashauri hajifichi).", "A smith settled near the roed in order te get advice (i.e. the one whe wants to get advice does not hide himself)."],
	...
	["Mungu si Athumani (Mungu si mwanadamu.", "Athumani ni jina la mtu).", "God is net Athumani (pers.", "name) (i.e. God is not human being)"],
	["Mvivu hujisingizia kutokuwa na nguvu.", "A lazy person pretends to have no strength."],
	["Mvua imemsafisha uovu (mvua imemnyeshea sana).", "Tae rain has washed his sins (i.e. it has rained heavily on him)."],
	...
	["Mwali unapochukua ubayake hufahamu.", "You know the girl's fuults after you have married her."],
  	["Mwana hakui kwa wazaziwe (hata mtu mgima ni mtoto kwa wazazi wake).", "A child is never old before its parents (i.e. even an adult is a child to his parents)."],
	...
	["Mwenye kiranga hasikitiwi wala akifa hawekewi matanga.", "One who is suspected of witchoraft is never pitied even when he dies people never hold funeral services."],
	["Mwenye kukana huvua (asemaye kuwa hana kitu fulani huthibitisha kuwa hanacho) .", "One who denies that he has nothing even undreases.(i.e. the one who says that he does not have something tries all ways to prove that he hasn't got it)."],
	...
	["Mzazi hakanwi (heshima kwa wazgazi ni muhimu).", "A parent is never denied (i.e. respect for one's p is of great importance)Vents"],
  	["Mzazi hali (mzazi hufikiria kwanza atakavyotunza mtoto apate chakula cha kumtosha).", "The parent never eats (i.e. the parent first thinks how he will feed the child)."],
	...
	["Nijapokufa ndipo niponapo (nikiwa katika shida nyingi ndipo nashtukia napata msaada).", "When I am about to die is when I survive (i.e. when I am"],
	["Ni jembe dogo likatalo kwekwe (kitu kidogo chaweza kufanya makubwa - usikidharau).", "It is a small thing that cuts weeds (i.e. a small thing can do great things - never despise it)"],
	["Nikaapo ndiko hupakuliwa chakula kilichoungua.", "Where I am sitting is where they dish what is burnt."],
	["Nikatae mafuta nitajipaka nini! (nikikataa kizuri nitatumia ninit) If I refuse oil or oream with what shall I anoint myself! (i.e. if refuse something nice what shall uset)"],
	["Nikatae ninit (nikikataa nitatumia nini!) What should I refuse! (i.e. if I refuse that, what whall T use)."],
	["Ni kizuri kabla hujashika mwenyewe.", "Tt is good before you take il in your hands."],
	["Ni mdomoni na puani (ni karibu sana kama kutoka mdononi kuingia puani).", "It is in the mouth and in the nose (i.e. it ts near as from the mouth to the nose)."],
	["Nimeona jicho la kiroboto (nimeona kitu ambacho Sijakiona maishani).", "T have seen an eye of a flea (i.e. I have seen something which I have never seen)."],
	["Nimeona jino la mjusi (nimeona kitu ambacho sijakiona maishani).", "l have seen u tooth cf a lizard (i.e. I have seen something whieh | have never seen)."],
	["Ni mtamu na mchungu (wakati fulani mtu fulani ni mwema na wakati mwingine ni mbaya).", "(He) is nice and nasty (i.e. sometimes somebody is nice and sometimes bad or too angry)."],
	...
	["Nina mdomo nawe una mdomo halafu waniambia 'piga yowe'? I have a mouth, you have a mouth, then you tell me ‘ory!'? (i.e. you are asking me to do the orying for you)."],
  	["Ninatafuta (fedha) zinanikimbia (sina fedha).", "Iam searching for it (money) but it runs from me (i.e. i have no money)."],
	...
	["Roho huzaliwa (tabia ya mtoto huanza utotoni).", "Good spirit is born (i.c.", "good character begins in childhood)."],
	["Sema ukweli uutafune (ukweli utakuokoa).", "Say the truth and eat it (i.e. the truth will save you)."],
	["Shukrani haitimilizi (shukrani ni alama tu ya kuonyesha moyo uliojaa shukrani nyingi mtu asivyoweza kueleza) Gratitude never satisfies (i.e. gratitude is only a sign to show the heart that is full of many thanks that one cannot express)."],
	["Si cha kuonja ukaacha (ni kitamu ukionja wataka kuendelea kukila).", "It is not something to taste and stop eating it (i.e. it is very sweet, when you taste it, you never like to stop eating it).", "Merely tasting it will not suffice.", "."],
	["(Ametia chumvi ati) si kifutu ni shina la mgomba (amekuza kitu sana katika maelezo yake).", "(ile has added salt that) it is not a snake, it is a banana stem (i.e. he has exaggerated)."],
	["Siku moja haifanyi nyama kuoza.", "One day does not make meat rot."],
	["Siku ga mwizi ni arobaini (mwizi ana siku yake ya kugunduliwa).", "The days of the thief are forty (i.e. a thief will one day be caught)."],
	["Simba asingekula watu alifundishwa.", "The lion could not eat peodle, but was taugnt to do so."],
	["Sina cha kutumia kuchekelea (sina kitu cha kutumia).", "IT have nothing to laugh with (i.e. I have nothing to use)."],
	["Sisi hutibu Mungu huponya.", "We treat, but God he Be"],
	["Sote tu watu wake (mauti) (sote tutakufa).", "We all belong to it (death) (i.c.", "we all shall die)."],
	...
	["Tumekula ng'ombe mzima tusishindwe na mkia.", "We have eaten the whole cow, we shouldn'+ fail to eat the tail."],
  	["Tunga kama mboni ya jicho (tunza vizuri sana).", "Keep (it) as the pupil of an eye (i.e. keep it safely).", "io."],
	["Tusipokutana mvua ikinyesha tutakutana jua likiwaka (tusipokutana wakati wa furaha - kukiwa sherehe n-k.", "tutakutana wakati wa shida) .", "Tf we do not meet when it is raining (when there are festivals) we shall meet when it is sunny (when there will be difficulties)."],
	...
	["Uchawi wa mdomoe huzidi wa dawa (Maneno ni ya hatari sana kuliko dawa).", "The bewitchment of the mouth surpases that of the medicine (i.e. words are dangerous than medicine)."],
	...
	["Ukitaka kumpangusa machozi aliaye uwe tayari kushika machozi yake (ukitaka kumsaidia fulani nawe wachukua mzigo wake).", "When you want to wipe away someono's tears you also touch his tears (i.e. when you want to help someone you take his burden)."],
	...
	["Umeacha kula ukajikuna? (Mithali hii hutumiwa hasa kumwonya mtoto anayeacha kula akaanza kuchezacheza).", "You have stor (This proverb i eating).", "you are soratching yoursel warn a child who pluys while"],
	...
	["Unaficha kitakachojionyesha (mimba).", "You are hiding what will be seen (e.g.", "pregnancy)."],
	...
	["Unalia machozi ya mamba (unajifanya kuhurumia).", "You are shedding orocodile tears."],
	["Unalia maziwa? (Mithali hii hutumiwa hasa kumwonya mtoto kuwa kulia kwake hakuwezi kumsaidia afadhali kuacha kulia).", "Ave you shedding out tears of milk? (This proverb is used to warn a child that its orying cannot help it, it is worthwhile keeping bd."],
	...
	["Useme “nililala njaa' usiseme “tulilala njaa' (usisemee kwa ujumla hujui wengine walivyo).", "You can 'T slept hungry last night', but not 'we slept hungry night' (i.e. do not genavalize, you do not know how others are),"],
	...
	["Usichokitenda hakikuhangaishi (wakikunenea uongo ukashikwa huhangaiki, ukweli utaonekana).", "What you have does not worry ycu (i.e. cvhey lie that you something wrong, wnen you are caught udo nol worry bee e truth will oul).", "ye"],
	["Usijipende kama ajinyonyaye.", "Do not love yourseli as someone whe sucks oneself."],
	["Usijisifu na kujigamba kabla hujaona (usijisifu kuwa una kitu fulani na kumbe bado hujakiona huenda usikipate).", "De not boast before seeing ( i.e. do not boast of wnat you have not yet got, perhups you w will mot get it)."],
	["Usikolima kwa nini kupachungulia? Way do you look where you do nct cultivate."],
	["Usiku hautoi siri (ni hatari kuzungumza siri usiku huenda watu nie wakasikia).", "Never give out @ seoret at night (i.e. it is dangerous to tell a seoret at night, someone may be cutside listening)."],
	["Usiku hauweki siri au usiku Hutoa siri.", "The night gives out seorets."],
	...
	["Usingizi wa mvivu huja asubuhi.", "The sleep of a lazy person comes at da Usinionee wivu huletwa na jasho (kwa kufanya kazi kwa bidii mtu hupata chakula, mali n.k.).", "Do not envy me, they are produced by sweat (i.e. by working hard one gets food, we etc.)."],
	...
	["Usipopambazuka hufungua jinsi ulivyo (ukiona jambo limeshindikamana hukichukua jinsi lilivyo).", "if it does not dawn you open as it is (i.e. if you see something that is too difficult you leave it as it is)."],
	...
	["Utakachobeba hakikupaki umande (afadhali kuchukua uwezacho kubeba).", "What you will bear does not smear you with dew (i.e. take what you are able to carry)."],
	...
	["Visivyo na pongezi havistawi (pongezi humtia mtu bidii).", "What is not blessed does not succeed."],
	...
	["Wafanya kisebusebu na kiroho kipapapo (unajifanya) .", "You are pretending you are not excited while your heart is pounding."],
	["Wakaao mvua inyeshapo hawafi (kule mvua inyeshako watu hawapatwi na njaa; hulima, hupanda na kuvuna).", "Those who live where it rains never die (i.e. where it rains people never get faming; they cultivate, plant and harvest)."],
	...
	["Wamemshukuru kupika vizuri amelamba mwiko (walipomshukuru naye akazidi kujisifu mno).", "They praised him for gocd cooking then he licked the spoon (i.e. they praised him and instead of being humble he was too proud)."],
	...
	["Wapendanao huwa safi (wapendanao hujiona wakiwa safi) Those who love one another are pure (i.e. those who love one another never see their faults).", "ef.", "Love is blind."],
	...
	["Watu hawazungumzi na mali (mtu hastahili kujivunia mali).", "People never talk to riches (i.e. a persen ought not to be proud of his wealth)."],
	["Wasema huli kuku na huku wala mayai? You say that you do not eat chicken how come you eat eg"],
	["Watu huuliza kama mtoto analia (kulia kwa mtoto huonyesha afya yake ~hasa wakati anapozaliwa).", "People ask whether the child is orying (i.e. the ory of a child indicates its health - especially when it is being born)."],
	...
	["Weka panya asipoweza kufika (weka vizuri sana mwarifu au Mwizi asipofika).", "Keep (it) where u pat cannot reach it (i.e. keep it safely wh » a robber cannot reach)"],
	["Wimbo mbaya hauimbwi mtoto (wimbo mbaya ukiimbwa mbele ya mtoto, mtoto huyo ataiga mambo mabaya) .", "A bad song is never sung to a child (i.e. if a bad song is sung to a child, that child will learn bad habits)."],
	...
	["Zawadi si ndogo.", "A prize is never small."],
	["(Ng'ombe) zilizomo zizini hazipigwi radi (watu wakiwa chini ya uongozi bora hawawezi kupatwa na hatari).", "(The cattle) that are in the shelter are never struck by the lightning (i.e. people under good leadership or protection cannot be harmed)."],
 	["(Nyumba) zilizopakana huunguzana.", "(Houses) which are close together, burn together."],
	["Zisizo (ng'ombe, mbuzi n.k.) na mchungaji hujisambaza ovyo.", "(Cattle or goats) which have no herdsman scatter."],
	["Zisizo (ng'ombe, au mbuzi) na mchungaji hula bidhaa vya wengine.", "(Cattle or goats) which have no herdsman graze in others! fields."],
	["Ziwa husaidia (waliozaliwa pamoja husaidiana).", "The breast helps (i.e. those of the same parents help one another)."]
 ]
